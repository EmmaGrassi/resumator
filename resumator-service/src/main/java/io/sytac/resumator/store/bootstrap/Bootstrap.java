...
public class Bootstrap {
    ...
    @Inject
    public Bootstrap(final EventStore store, final OrganizationRepository organizationRepository,
                     final ProfileRepository profileRepository, final ObjectMapper objectMapper) {
    ...
    private void replayEvent(Event event) {
        try {
            final ReplayEventConfig replayEventConfig = new ReplayEventConfig(organizationRepository, profileRepository, objectMapper);
